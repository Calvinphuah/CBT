        ...
        >
              ...
              <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                ...
                <div class="mt-2">
                  <p class="text-sm text-gray-500">
                    Are you sure you want to delete this CBT entry? This action
                    cannot be undone.
                  </p>
                </div>
              </div>
          ...
          <div class="px-4 py-3 bg-gray-50 sm:flex sm:flex-row-reverse sm:px-6">
            <button
              type="button"
              :disabled="loading"
              class="inline-flex justify-center w-full px-3 py-2 text-sm font-semibold text-white bg-red-600 rounded-md shadow-sm hover:bg-red-500 disabled:opacity-50 sm:ml-3 sm:w-auto"
              @click="onConfirm"
            >
              <svg
                v-if="loading"
